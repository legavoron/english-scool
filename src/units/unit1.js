...
const unit1 = [
    ...
    {
      word: 'Могу ли я узнать ваш номер?',
      translate: 'Could i have youre number', 
      url: good
    },
    {
      word: 'Не мог бы ты подвезти Дженни в аэропорт?',
      translate: 'Could you pick up Jenny at the airport?', 
      url: good
    },
    {
      word: 'Что-нибудь еще?',
