...
const LevelsList = ({chooseLevels, colors, chooseTask}) => {
    ...
    const levelsValue = ["Все", "A2: Unit 1", "A2: Unit 2", "A2: Unit 3", "A2: Unit 4", "A2: Unit 5", "A2: Unit 6", "A2: Unit 7", "A2: Unit 8", "A2: Unit 9", "A2: Unit 10", "A2: Unit 11", "A2: Unit 12", "A2: Unit 13", "A2: Unit 14", "A2: Unit 15", "A2: Unit 16","A2: Unit 17", "B1: Unit 1", "B1: Unit 2"];
